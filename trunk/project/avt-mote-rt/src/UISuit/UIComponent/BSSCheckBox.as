	...
	public class BSSCheckBox extends Sprite {
		...
		: BSSCheckBox {
			...
			for (var i : int = 0 ; i < 2 ; i++ )
			{
				...
				GraphicsUtil.DrawRect( shape.graphics , 0 , 0 , w, w , 0xFFFFFF , 0.7 , 0 ,0 ,0.1  );
				if (i == 1)
				{
				...
				shape = new Shape();
				GraphicsUtil.DrawRect( shape.graphics , 0 , 0 , w, w , 0xFFFFFF , 0.9 , 0 ,0 ,0.5  );
				if (i == 1)
				{
					shape.graphics.lineStyle(w > 15 ? 1.5 : 1, 0);
					shape.graphics.moveTo(w * 0.15, w * 0.40);
				...
				shape = new Shape();
				GraphicsUtil.DrawRect( shape.graphics , 0 , 0 , w, w , 0x62B0FF , 0.7 ,  0 , 0xFFFFFF ,0.5  );
				if (i == 0)
				{
					shape.graphics.lineStyle(w > 15 ? 1.5 : 1, 0);
					shape.graphics.moveTo(w * 0.15, w * 0.40);
