	...
	public class BSSPanel extends Sprite {
		...
		: void 
		{
            ...
            : BSSPanel  {
				...
				GraphicsUtil.DrawRect (bgShape.graphics , 0, 0, w, h, 0xEEEEEE , 0.8, 1, 0xCCCCFF);
				GraphicsUtil.DrawRect (bgShape.graphics , 0, 0, w, 18, 0xBBBBFF , 0.8);
			    ...
			    {	
        			...
        			{	
        				...
        				GraphicsUtil.DrawRect( shape.graphics , 0 , 0 ,closeBtnH, closeBtnH , ((j == 2) ? 0xFF3333  :  ((j == 1) ? 0xFFDDDD : 0xFFFFFF )) , 0.5 + j * 0.1 , 0 , 0 ,0.15  );
