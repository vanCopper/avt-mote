package editor.module.brow  
{
	 ...
	 * @author ...
	 */
	public class ModuleBrowToolbar extends SripteWithRect
	{
		...
		*/
		...
		public function ModuleBrowToolbar() 
		{
			var lastBtn : DisplayObject;
			btnImport = BSSButton.createSimpleBSSButton(20, 20, StringPool.MODULE_BROW_IMPORT_IMAGE , true);
			btnImport.x = 5;
			btnImport.y = 5 ;
			lastBtn = addChild(btnImport) ;
			
			var _areaArray : Array = [];
			btnAF = BSSButton.createSimpleBSSButton(20, 20, StringPool.MODULE_BROW_ADD_FRAME , true , _areaArray);
			btnAF.x = 5 + lastBtn.x + lastBtn.width;
			btnAF.y = 5 ;
			lastBtn = addChild(btnAF) ;
			btnAF.statusMode = true;
			
			btnLocate = BSSButton.createSimpleBSSButton(20, 20, StringPool.MODULE_BROW_LOCATE , true, _areaArray);
			btnLocate.x = 5 + lastBtn.x + lastBtn.width;
			btnLocate.y = 5 ;
			lastBtn = addChild(btnLocate) ;
			btnLocate.statusMode = true;
			
			btnZAdj = BSSButton.createSimpleBSSButton(20, 20, StringPool.MODULE_BROW_Z_ADJUST , true, _areaArray);
			...
			*/
			...
			btnView = BSSButton.createSimpleBSSButton(20, 20, StringPool.MODULE_BROW_VIEW , true, _areaArray);
