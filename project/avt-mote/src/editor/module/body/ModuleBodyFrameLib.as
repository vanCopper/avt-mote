package editor.module.body 
{
	 ...
	 * @author Blueshell
	 */
	public class ModuleBodyFrameLib  extends Sprite
	{
		
		public var item : BSSItemListScrollBar;
		public var clickFuntion : Function;
		
		public function ModuleBodyFrameLib() 
		{
		...
		public function getModuleBodyFrameData(_v : String) : ModuleBodyFrame
		{
			for each (var mef : ModuleBodyFrame in m_frameList)
			{
				if (mef.name == _v)
					return mef;
			}
		...
		private var m_frameList : Vector.<ModuleBodyFrame> = ModuleBodyData.s_frameList;
		public function addTexture(_t : ModuleBodyFrame , a_name : String , clickAtAdd : Boolean = false ) : void
		{
			for each (var _oldData : ModuleBodyFrame in m_frameList)
			{
			...
			var __frame : ModuleBodyFrameSprite = _t.createSprite();
			__frame.refresh();
...
class ItemContainer extends Sprite {
	...
	public var mef : ModuleBodyFrameSprite;
	
	
	public function ItemContainer(a_mef : ModuleBodyFrameSprite , a_indi : TextField)
	{
