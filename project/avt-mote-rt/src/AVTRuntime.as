package 
{
	 ...
	 * @author blueshell
	 */
	public class AVTRuntime extends Sprite 
	{
		...
		public function AVTRuntime():void 
		{
			if (stage) init();
		...
		private function init(e:Event = null):void 
		{
			...
			// entry point
			m_player = new AVTMPlayer(new TestDataBA() , new TestDataBD());
			addChild(m_player);
		...
		private function onUpdate(e:Event):void 
		{
			...
			m_player.eyeAimX = m_player.mouseX*2;
			m_player.eyeAimY = m_player.mouseY*2;
